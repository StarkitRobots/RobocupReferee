...
namespace RhobanReferee{
    ...
    class Constants{
        public:
            ...
            static const int STATE2_PENALTY_KICK = 5;

            /* Penalties */
            static const short PENALTY_NONE = 0;

            /* FIELD INFORMATIONS (all size in cm) */
            /* Miscellaneous */
            static const double lineWidth;
            static const double centerRadius;
            static const double borderStripWidth;// Minimum
            /* Penalty Mark */
            static const double penaltyMarkDist;//To closest Goal
            static const double penaltyMarkLength;
            /* Goals */
